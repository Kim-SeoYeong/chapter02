...
public class TVApp {
	...
	public static void main(String[] args) {
		...
		tv.volume(120);		//(채널: 7, 볼륨: 100, 전원: true)
		tv.status();		//(채널: 7, 볼륨: 100, 전원: true)
		
		tv.volume(false);	//(채널: 7, 볼륨: 99, 전원: true)
		tv.status();		//(채널: 7, 볼륨: 99, 전원: true)
		
		tv.channel(0);		//(채널: 1, 볼륨: 99, 전원: true)
		tv.status();		//(채널: 1, 볼륨: 99, 전원: true)
